...
player=pg.image.load('miner/miner1.png').convert_alpha()
...
minerAnimation=[pg.image.load('miner/miner1.png').convert_alpha(),pg.image.load('miner/miner2.png').convert_alpha(),pg.image.load('miner/miner3.png').convert_alpha(),pg.image.load('miner/miner2.png').convert_alpha()]
